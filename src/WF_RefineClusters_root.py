...
def main(argv):
	...
	logging.basicConfig(filename=my_dir + 'RefineClusters_root.log', format=FORMAT, filemode='w', level=logging.DEBUG)
	...
	# get synteny data
	# for c in children:
	synFile = node_dir + mrca + "/synteny_data.pkl"
	pklFile = open(synFile, 'rb')
	pickleSyn = pickle.load(pklFile)
	pklFile.close()
