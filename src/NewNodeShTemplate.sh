...
#SYNERGY2_PATHWF_RefineClusters_leaf_centroid_newmatrix.py -dir #WORKING_DIRnodes/ -node #NODE -alpha #ALPHA -beta #BETA -gamma #GAMMA -gain #GAIN -loss #LOSS #CHILD1 #CHILD2 #NOSYNTENY
