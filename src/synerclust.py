...
def main():
	...
	parser.add_argument('-m', '--min-best-hit', type=float, dest="min_best_hit", default=0.8, help="Minimal %% of match length for Blastp hits compared to best one. (default = 0.8)")
	...
	parser.add_argument('-qt', '--queue-threshold', type=int, dest="thresq", default=25, help="Level threshold to determine whether to use the short or long queue (unused if not run in UGER mode)(default = 25")
